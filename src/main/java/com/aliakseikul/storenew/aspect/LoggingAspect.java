package com.aliakseikul.storenew.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.aliakseikul.storenew.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.aliakseikul.storenew.service.*.*(..))")
